...
st.set_page_config(page_title="Generate Synthetics", layout="centered")
...
st.title("Generate Input Files for Specfem2D")
...
# 2D FILE - generates xyz file for tomography. Example specfem files are provided
